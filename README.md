...
This app has been refactored into **Warp Weft Studio**, a Canva-native weaving pattern generator.

Current MVP:

- choose a weave preset
- edit warp and weft thread colors
- tune the weave structure
- generate a woven repeat sheet
- add the generated repeat sheet directly into a Canva design

This release is frontend-only. Leave `CANVA_BACKEND_HOST` empty for production bundles unless you later add a real hosted backend.

See [TODO.md](./TODO.md) for the implementation backlog and [MONETIZATION_PLAN.md](./MONETIZATION_PLAN.md) for the commercial rollout path.
